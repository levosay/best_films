 ...
 */
import type { GetApiV22FilmsOrder } from './getApiV22FilmsOrder'
import type { GetApiV22FilmsType } from './getApiV22FilmsType'

export type GetApiV22FilmsParams = {
	countries?: number[]
	genres?: number[]
	order?: GetApiV22FilmsOrder
	type?: GetApiV22FilmsType
	ratingFrom?: number
	ratingTo?: number
	yearFrom?: number
	yearTo?: number
