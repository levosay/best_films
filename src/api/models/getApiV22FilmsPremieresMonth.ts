...
export type GetApiV22FilmsPremieresMonth =
	typeof GetApiV22FilmsPremieresMonth[keyof typeof GetApiV22FilmsPremieresMonth]

// eslint-disable-next-line @typescript-eslint/no-redeclare
export const GetApiV22FilmsPremieresMonth = {
	JANUARY: 'JANUARY',
	FEBRUARY: 'FEBRUARY',
	MARCH: 'MARCH',
	APRIL: 'APRIL',
