...
export type GetApiV21FilmsReleasesMonth =
	typeof GetApiV21FilmsReleasesMonth[keyof typeof GetApiV21FilmsReleasesMonth]

// eslint-disable-next-line @typescript-eslint/no-redeclare
export const GetApiV21FilmsReleasesMonth = {
	JANUARY: 'JANUARY',
	FEBRUARY: 'FEBRUARY',
	MARCH: 'MARCH',
	APRIL: 'APRIL',
